...
export async function setupWorld(provider: DojoProvider) {
    ...
    function admin() {
        ...
        const add_game_format = async (props: { account: Account, description: bigint, turn_expiry: number, total_time_per_side: number, total_time_string: bigint, increment: number }) => {
            try {
        ...
        return {
            add_game_format, remove_game_format, world
        };
    }
